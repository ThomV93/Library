...
const library = (() => {
    ...
    //initialize the necessary functions for the library module
    let boardInit = () => {
        openForm();
        createBookForm();
        editBtnFormlistener();
    ...
    let editBtnFormlistener = () => {
        formEditBtn.addEventListener("click", () => {
            ...
            correctCardInfo.childNodes[2].innerHTML = `${pages_input.value} pages`;
    ...
    let toggleSlider = (item, iteration) => {
        if (item.read) {
